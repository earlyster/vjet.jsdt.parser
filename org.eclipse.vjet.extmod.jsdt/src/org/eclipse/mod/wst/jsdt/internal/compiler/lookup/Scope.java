...
// import org.eclipse.mod.wst.jsdt.core.JavaScriptCore; // VJET MOD
// VJET MOD import org.eclipse.mod.wst.jsdt.internal.core.Logger;
...
public abstract class Scope implements TypeConstants, TypeIds {
	...
	*/
	...
	// VJET MOD - NOT SUPPORTING TYPING
...
//	}
	...
	public MethodBinding findMethodForArray(
		...
		TypeBinding[] argumentTypes,
		InvocationSite invocationSite) {
		// VJET MOD - no inferrencing in parser
		return null;
//		
...
//			} else {
//				
//				// VJET MOD - No constructor search in parser
////				if(methods.length > 1) {
...
//	}
	...
	// VJET MOD - NO TYPING IN AST PARSER
